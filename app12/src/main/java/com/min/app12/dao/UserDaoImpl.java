...
public class UserDaoImpl implements IUserDao {
  ...
  // 아래 코든느 lombok에서 @Slf4j Annotation으로 지원합니다.
  ...
  @Override
  public UserDto selcetUserByMap(Map<String, Object> map) {
    log.debug(map.toString()); // 인자 값은 %msg로 표시됩니다.
    return template.selectOne("mybatis.mappers.userMapper.selcetUserByMap", map);
  }
